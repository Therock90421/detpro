...
from mmdet.apis import multi_gpu_test, da_single_gpu_test
...
def main():
    ...
    if isinstance(cfg.data_t.val, dict):
        cfg.data_t.val.test_mode = True
    elif isinstance(cfg.data_t.val, list):
        for ds_cfg in cfg.data_t.val:
