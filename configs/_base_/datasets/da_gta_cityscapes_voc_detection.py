...
data_s = dict(
    ...
    train=dict(
        classes=classes,
        type=dataset_type,
        ann_file=data_root_s + 'VOC2012/ImageSets/Main/train.txt',
        img_prefix=data_root_s + 'VOC2012/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        classes=classes,
        ann_file=data_root_s + 'VOC2012/ImageSets/Main/val.txt',
        img_prefix=data_root_s + 'VOC2012/',
...
data_t = dict(
    ...
    train=dict(
        type=dataset_type,
        classes=classes,
        ann_file=data_root_t + 'VOC2007/ImageSets/Main/source_trainval.txt',
